...
const DEVELOP_RESPONSE = {
    ...
    "items": [
        ...
        },
        {
            ...
            "from_id": 485577591,
            "date": 1654325916,
            "text": "Качественно и быстро, с объяснением работы\nставлю класс",
            "post_id": 765,
            "owner_id": 270022066,
            "parents_stack": [],
            "attachments": [
        ...
        },
        {
            ...
            "from_id": 364162176,
            "date": 1654328473,
            "text": "Сделал 6 лабораторных работ! Уровень знания языка хороший. Если возникали какие-то вопросы, то эффективно и оперативно помогал их решить. Всем советую",
            "post_id": 765,
            "owner_id": 270022066,
            "parents_stack": [],
            "thread": {
        ...
        },
        {
            ...
            "from_id": 143572988,
            "date": 1654371988,
            "text": "Сделал 5 лабораторных работ качественно, если возникали какие-то ошибки, то быстро всё решали. На вопросы по теории от препода помогал отвечать. 👍🏻",
            "post_id": 765,
            "owner_id": 270022066,
            "parents_stack": [],
            "thread": {
        ...
        },
        {
            ...
            "from_id": 669968049,
            "date": 1654511854,
            "text": "Спасибо Марату, очень помог в выполнении (и подгонке) лаб, с вопросами по теории помогал тоже.",
            "post_id": 765,
            "owner_id": 270022066,
            "parents_stack": [],
            "thread": {
        ...
        },
        {
            ...
            "from_id": 192492502,
            "date": 1656611708,
            "text": "Марат очень классный чел. Коммуникация отличная, отвечает быстро. Работа очень качественная, всем советую. Оставляйте пожалуйста отзывы, чтобы продвигать Марата, как отличного специалиста.",
            "post_id": 765,
            "owner_id": 270022066,
            "parents_stack": [],
            "thread": {
        ...
        },
        {
            ...
            "from_id": 171995306,
            "date": 1666523580,
            "text": "Сделал мне лабу от которой зависила моя жизнь, и хоть большую часть я не понял, думая что мне какой-то костыль написали, оказалось, что код очень даже много задачный, на столько, что препод подумал сначала, что я что-то не то сделал. Слава богу Марат до конца держал меня за ручку и я не смотря на мою панику, с помощью комментариев Марата смог ловко парировать непонимание преподавателя, после чего получил зачёт. Вывод: Учите прогу, хотя бы на эллементарном уровне, а за реализацию кода не волнуйтесь, Марат весьма хорошо об этом позаботится.",
            "post_id": 765,
            "owner_id": 270022066,
            "parents_stack": [],
            "thread": {
        ...
        },
        {
            ...
            "from_id": 335242778,
            "date": 1666526195,
            "text": "Марат помог 2 раза в разных форматах, в обоих случаях всё на высшем уровне! Лабораторные работы, даже с учётом крайне сжатых сроков, были идеальными и выполнены с запасом по времени. Но больше всего Марат помог с работой на комиссии под жёстким наблюдением. Абсолютно качественная, быстрая и организованная помощь с практическим заданием - комиссию сдал прекрасно. После самого задания даже рассказал, что ответить на потенциальные вопросы. Крайне рекомендую!",
            "post_id": 765,
            "owner_id": 270022066,
            "parents_stack": [],
            "thread": {
        ...
        },
        {
            ...
            "from_id": 323710929,
            "date": 1666554345,
            "text": "Сделал 3 лабораторных работ, дешево быстро и качественно. На все вопросы отвечает и разъясняет, всем рекомендую  👌",
            "post_id": 765,
            "owner_id": 270022066,
            "parents_stack": [],
            "thread": {
